...
namespace Dapper
{
    ...
    public static partial class SimpleCRUD
    {
        ...
        public static int Insert<TKey>(this IDbConnection connection, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        private static IEnumerable<PropertyInfo> GetUpdateableProperties(object entity)
        {
            ...
            //remove ones that are not update -Yan20170301
            updateableProperties = updateableProperties.Where(p => p.GetCustomAttributes(true).Any(attr => attr.GetType().Name == typeof(NotUpdateAttribute).Name) == false);
